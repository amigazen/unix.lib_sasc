 ...
 * syserr.c - System error messages
 *
 * Based on PDC syserr.c by J.A. Lydiatt
...
/**
 * @brief System error message list
 * 
 * Array of error message strings corresponding to errno values.
 * Used by perror() and strerror() functions.
 */
char *sys_errlist[] = {
    "No error",                           /* 0 */
    ...
    "Cannot exec a shared library directly", /* ELIBSCN */
    "Interrupted system call should be restarted", /* ELIBMAX */
    "Cannot exec a shared library directly", /* ELIBEXEC */
    "Illegal byte sequence",              /* EILSEQ */
    "Interrupted system call",            /* EINTR */
    "Restart the system call",            /* ERESTART */
...
/**
 * @brief Number of error messages in sys_errlist
 * 
 * This variable contains the number of error messages in the sys_errlist array.
 * It is used by perror() and strerror() to validate errno values.
 */
